...
Feature: Remote Debugger Invalid Profile
  ...
  Scenario: Send WebPA event for Issuetype Device.Info_ab1bghjh and verify logs
    ...
    Then the logs should be seen with "Generated filename: AABBCCDDEEFF_DEVICE_INFO_AB1BGHJH" and upload success
