...
void processIssueTypeEvent(data_buf *rbuf)
{
    ...
    RRD_OTEL_LOG(RDK_LOG_DEBUG, LOG_OTEL, "[%s:%d]: [OTEL] Started child span for processIssueTypeEvent\n", __FUNCTION__, __LINE__);
#endif
    RDK_LOG(RDK_LOG_DEBUG, LOG_REMDEBUG, "[%s:%d]: ...Entering.. \n", __FUNCTION__, __LINE__);
    if (NULL != rbuf)
    {
    ...
    RRD_OTEL_LOG(RDK_LOG_DEBUG, LOG_OTEL, "[%s:%d]: [OTEL] Stopping child span for processIssueTypeEvent\n", __FUNCTION__, __LINE__);
#endif
    RDK_LOG(RDK_LOG_DEBUG, LOG_REMDEBUG, "[%s:%d]: ...Exiting...\n", __FUNCTION__, __LINE__);
    return;
}
...
static void processIssueType(data_buf *rbuf)
{
    ...
    RRD_OTEL_LOG(RDK_LOG_DEBUG, LOG_OTEL, "[%s:%d]: [OTEL] Started child span for processIssueType\n", __FUNCTION__, __LINE__);
#endif
    RDK_LOG(RDK_LOG_DEBUG, LOG_REMDEBUG, "[%s:%d]: ...Entering.. \n", __FUNCTION__, __LINE__);
    ...
    RDK_LOG(RDK_LOG_DEBUG, LOG_REMDEBUG, "[%s:%d]: ...Exiting...\n", __FUNCTION__, __LINE__);
#if defined(ENABLE_OTEL) && !defined(GTEST_ENABLE)
    RRD_OTEL_LOG(RDK_LOG_DEBUG, LOG_OTEL, "[%s:%d]: [OTEL] Stopping child span for processIssueType\n", __FUNCTION__, __LINE__);
    rdk_otlp_finish_child_span();
#endif
    return;
}
...
static void processIssueTypeInStaticProfile(data_buf *rbuf, issueNodeData *pIssueNode)
{
    ...
    RRD_OTEL_LOG(RDK_LOG_DEBUG, LOG_OTEL, "[%s:%d]: [OTEL] Started child span for processIssueTypeInStaticProfile\n", __FUNCTION__, __LINE__);
#endif
    RDK_LOG(RDK_LOG_DEBUG, LOG_REMDEBUG, "[%s:%d]: ...Entering.. \n", __FUNCTION__, __LINE__);
