...
pytest --json-report --json-report-summary --json-report-file $RESULT_DIR/rrd_append_dynamic_profile_report.json test/functional-tests/tests/test_rrd_append_dynamic_profile_report.py
